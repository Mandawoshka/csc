...
<div class="hidden" title="{__("add")}" id="content_tradein_popup_add_first">
    ...
    <form name="tradein_form" id="form_{$id}" action="{""|fn_url}" method="post" class="cm-ajax cm-processing-personal-data" data-ca-processing-personal-data-without-click="true">
        ...
        <div class="ty-control-group">
            ...
            <div class="ty-controls">
                <select class="select2-single" id="ecl-tradein_select_category_first" name="selected_category_first" style="width: 100%;margin-top: 10px;" onchange="fn_ms_trade_in_choose_category(1)">
        ...
        <div class="ty-control-group">
            ...
            <div class="ty-controls">
                <select class="select2-single" name="selected_subcategory_first" id="ecl-tradein_select_subcategory_first" style="width: 100%;margin-top: 10px;" {if empty($subcategories_first)}disabled="disabled"{/if} onchange="fn_ms_trade_in_choose_category(2)">
        ...
        <div class="ecl-tradein__button_block">
            ...
            <input type="hidden" name="result_ids" value="ms_trade_in_container">
    ...
    function fn_ms_trade_in_choose_category(step) {
...
<div class="hidden" title="{__("add")}" id="content_tradein_popup_add_second">
    <form name="tradein_form_b" id="form_tradein_popup_add_second" action="{""|fn_url}" method="post" class="cm-ajax cm-processing-personal-data" data-ca-processing-personal-data-without-click="true">
        ...
        <div class="ty-control-group">
            ...
            <div class="ty-controls">
                <select class="select2-single" id="ecl-tradein_select_category_second" name="selected_category_second" style="width: 100%;margin-top: 10px;" onchange="fn_ms_trade_in_choose_category_sec(1)">
        ...
        <div class="ty-control-group">
            <label class="ty-control-label">{__("select_product_brand")}</label>
            <div class="ty-controls">
                <select class="select2-single" name="selected_subcategory_second" id="ecl-tradein_select_subcategory_second" style="width: 100%;margin-top: 10px;" {if empty($subcategories_second)}disabled="disabled"{/if} onchange="fn_ms_trade_in_choose_category_sec(2)">
     ...
     <script type="text/javascript">
    function fn_ms_trade_in_choose_category_sec(stepsec) {
...
<div class="hidden" title="{__("make_a_request")}" id="content_tradein_popup_confirm">
    ...
    <div class="ty-control-group">
        ...
        <input id="call_data_ms_trade_in_name" size="50" class="ty-input-text-full" type="text" name="call_data[name]" value="{$call_data.name}" />
    </div>
    <div class="ty-control-group">
        <label for="call_data_ms_trade_in_phone" class="ty-control-group__title cm-mask-phone-label cm-required">{__("phone")}</label>
        <input id="call_data_ms_trade_in_phone" class="ty-input-text-full cm-mask-phone ty-inputmask-bdi" size="50" type="text" name="call_data[phone]" value="{$call_data.phone}" data-enable-custom-mask="true" />
    </div>
